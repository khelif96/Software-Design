...
public class AddressBookDisplay extends JFrame
{
   ...
   private JTextField stateSearchTextField;
   private JPanel stateSearchPanel;
   private JButton stateSearchButton;
   private JLabel stateSearchLabel;
   ...
   public AddressBookDisplay()
   {
      ...
      }catch(SQLException e){ // Handle SQL Exception For to many connections to database
         JOptionPane.showMessageDialog(this, "Could Not establish Database Connection. \nClose any other Connections and try again.",
      ...
      stateSearchPanel = new JPanel();
      stateSearchButton = new JButton();
      stateSearchLabel = new JLabel();
      stateSearchTextField = new JTextField(10);
      ...
      stateSearchLabel.setText("State: ");
      stateSearchPanel.setLayout(
              new BoxLayout(stateSearchPanel,BoxLayout.X_AXIS));
      stateSearchPanel.setBorder(BorderFactory.createTitledBorder("Find an entry by State"));
      stateSearchPanel.add(Box.createHorizontalStrut(10));
      stateSearchPanel.add(stateSearchLabel);
      stateSearchPanel.add(Box.createHorizontalStrut(10));
      stateSearchPanel.add(stateSearchTextField);
      stateSearchPanel.add(Box.createHorizontalStrut(10));
      stateSearchButton.setText("Find");
      stateSearchButton.addActionListener(
              new ActionListener() {
                 @Override
                 public void actionPerformed(ActionEvent evt) {
      ...
      stateSearchPanel.add(stateSearchButton);
      stateSearchPanel.add(Box.createHorizontalStrut(5));
      add(stateSearchPanel);
   ...
   private void updateButtonActionPerformed(ActionEvent evt){
      ...
      int result = personQueries.updatePerson(firstNameTextField.getText(),
              ...
              phoneTextField.getText(),stateTextField.getText(),idTextField.getText());
   ...
   private void deleteButtonActionPerformed(ActionEvent evt){
      ...
      int result = personQueries.deleteCurrentPerson(idTextField.getText());
      if (result == 1)
         JOptionPane.showMessageDialog(this,"Person Deleted!","Person Deleted",JOptionPane.PLAIN_MESSAGE);
      else
         JOptionPane.showMessageDialog(this,"Couldn't Delete Person","Error Could Not Delete Person", JOptionPane.PLAIN_MESSAGE);
      browseButtonActionPerformed(evt);
   }
   ...
   // handles call when stateQueryButton is clicked
   private void stateQueryButtonActionPerformed(ActionEvent evt){
      results = personQueries.getPeopleByState(stateSearchTextField.getText());
      numberOfEntries = results.size();
   ...
   private void browseButtonActionPerformed(ActionEvent evt)
   {
      try
      {
         ...
         if (numberOfEntries != 0)
         {
            ...
            emailTextField.setText(currentEntry.getEmail());
            phoneTextField.setText(currentEntry.getPhoneNumber());
            System.out.println("CurrentState " + currentEntry.getState());
            stateTextField.setText(currentEntry.getState());
            maxTextField.setText("" + numberOfEntries);
            indexTextField.setText("" + (currentEntryIndex + 1));
            nextButton.setEnabled(true);
